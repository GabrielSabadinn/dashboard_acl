    ...
    <div class="card-header pb-0">
      <div class="row">
        <div class="col-lg-6 col-7">
          <h6>Cursos para esta semanae</h6>
          <p class="text-sm mb-0">
            <i class="fa fa-check text-info" aria-hidden="true"></i>
            <span class="font-weight-bold ms-1">30 feitos</span> esse mês
          </p>
        </div>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Curso Teste [Geral]</h6>
                  </div>
                </div>
              </td>
              <td>
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Curso Teste [Trabalhista]</h6>
                  </div>
                </div>
              </td>
              <td>
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Curso Teste [Federal]</h6>
                  </div>
                </div>
              </td>
              <td>
